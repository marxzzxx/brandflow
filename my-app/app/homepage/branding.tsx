...
export default function branding() {
  return (
    <div id="about" className="relative isolate overflow-hidden bg-[#fffcfa] px-6 py-14 sm:py-14 lg:overflow-visible lg:px-0">
      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="lg:max-w-lg">
              <h1 className="mt-2 text-3xl font-bold tracking-tight text-[#1E1E1E] sm:text-4xl">Building Brands That Resonate</h1>
            </div>
          </div>
        </div>
        <div className="-ml-12 -mt-12 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
          <img
            ...
            src="/brand_banner.webp"
            className="w-[700px] max-w-none rounded-2xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10 sm:w-[850px]"
          />
        </div>
          ...
          <div className="lg:pr-4">
            <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
              ...
              <ul role="list" className="mt-8 space-y-8 text-gray-600 ">
                <li className="flex gap-x-3 bg-[#FEFEFE] py-4 px-6 rounded rounded-[22px] shadow-lg border border-gray-400/10  h-[150px] max-[330px]:h-[320px] max-[380px]:h-[250px] max-[400px]:h-[320px] max-[550px]:h-[220px] ">
                  <Blocks aria-hidden="true" className="mt-1 h-8 w-8 flex-none text-blue-700" />
                  <span>
                    <strong className="font-semibold text-gray-900">Setup Accelerator</strong><br/>We craft a personalized content strategy, establish and identify your target audience to transform your profiles into engaging, conversion-driven hubs.
                  </span>
                </li>
                <li className="flex gap-x-3 bg-[#FEFEFE] py-4 px-6 rounded rounded-[22px] shadow-lg border border-gray-400/10 h-[150px] max-[330px]:h-[320px] max-[380px]:h-[250px] max-[400px]:h-[320px] max-[550px]:h-[220px]">
                  <Cog aria-hidden="true" className="mt-1 h-8 w-8 flex-none text-blue-700" />
                  <span>
                    <strong className="font-semibold text-gray-900">Content Engine</strong><br/>We reconstruct your meetings, podcasts, and voice memos into compelling bite-sized content, ensuring maximum visibility.
                  </span>
                </li>
                <li className="flex gap-x-3 bg-[#FEFEFE] py-4 px-6 rounded rounded-[22px] shadow-lg border border-gray-400/10 h-[150px] max-[330px]:h-[320px] max-[380px]:h-[250px] max-[400px]:h-[320px] max-[550px]:h-[220px]">
                  <Globe aria-hidden="true" className="mt-1 h-8 w-8 flex-none text-blue-700" />
                  <span>
                    <strong className="font-semibold text-gray-900">Growth Amplifier</strong><br/>We drive conversions by nurturing your community, managing engagement, and applying data-backed paid campaigns to reach and resonate with your audience.
                  </span>
                </li>
              </ul>
