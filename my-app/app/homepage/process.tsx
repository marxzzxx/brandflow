const posts = [
    {
      ...
      alt: 'An image of a futuristic jet generated by PiAPI\'s Midjourney API',
      description:
    ...
    },
    {
      ...
      alt: 'A face swapped image from PiAPI\'s Faceswap API',
      description:
    ...
    },
    {
      ...
      alt: 'A image of a sound wave illustrating PiAPI\'s Suno API',
      description:
  ...
  export default function Process() {
    return (
      <div id="tempt-service-section" className="bg-white pt-24 sm:pt-24">
